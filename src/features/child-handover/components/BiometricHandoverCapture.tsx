...
export const BiometricHandoverCapture = () => {
  ...
  const { videoRef, isCameraActive, isFaceDetected, getDisplayMessage } =
    useBiometricCapture();
  ...
  return (
    <div className="biometric-handover-capture">
      <div className={cameraBoxClass}>
        ...
        {isCameraActive && (
          <div
            className={`face-detected-indicator ${isFaceDetected ? "visible" : "warning"}`}
          >
            <span>
              {isFaceDetected
                ? "✓ Rostro detectado"
      ...
      <div className="fingerprint-section">
        <div className="fingerprint-card">
          {/* Icono de huella */}
          <div
            className={`fingerprint-icon-wrapper ${isFingerprintScanning ? "active" : ""}`}
          >
            <FingerprintPattern
              size={64}
              strokeWidth={1.5}
